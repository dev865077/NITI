...
| Formal proof boundary | [`docs/FORMAL_PROOF_BOUNDARY.md`](docs/FORMAL_PROOF_BOUNDARY.md) | Quote-ready distinction between proved models, demonstrated execution, assumptions, and explicit exclusions. |
| Layer 1 proof evidence bundle | [`docs/evidence/layer1-proof/`](docs/evidence/layer1-proof/) | Whitepaper claim summary, proof boundary, SPARK target inventory, formal-to-Bitcoin trace, and all-target GNATprove reproduction command. |
| Claim-to-SPARK matrix | [`docs/CLAIM_TO_SPARK_MATRIX.md`](docs/CLAIM_TO_SPARK_MATRIX.md) | Claim-level map from public proof statements to package specs, `Prove_*` procedures, and postconditions. |
...
| Bilateral restart recovery | [`docs/L3_BILATERAL_RESTART_RECOVERY.md`](docs/L3_BILATERAL_RESTART_RECOVERY.md) | Funding-phase recovery, adaptor-phase wait/refund/complete behavior, attestation recovery, and partial-loss fail-closed checks. |
| Bilateral malformed-message matrix | [`docs/L3_BILATERAL_MALFORMED_COUNTERPARTY.md`](docs/L3_BILATERAL_MALFORMED_COUNTERPARTY.md) | Unsupported versions, bad keys, duplicate nonces, bad funding, missing refunds, unordered timelocks, wrong adaptors, and mutated sighashes. |
...
| Bilateral lazy activation holder test | [`testnet/src/bilateral-lazy-activation-test.ts`](testnet/src/bilateral-lazy-activation-test.ts) | Prepared edge package copied to Alice, Bob, and watchtower holders; each completes the same bridge after oracle attestation, while wrong-outcome and missing-package paths fail. |
...
This file is part of NITI.

    NITI is free software: you can redistribute it and/or modify
    it under the terms of the GNU General Public License as published by
    the Free Software Foundation, either version 3 of the License, or
    (at your option) any later version.

    NITI is distributed in the hope that it will be useful,
    but WITHOUT ANY WARRANTY; without even the implied warranty of
    MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
    GNU General Public License for more details.

    You should have received a copy of the GNU General Public License
    along with NITI.  If not, see <https://www.gnu.org/licenses/>
