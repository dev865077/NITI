...
| Layer 2: single cDLC execution | One parent outcome can activate one child funding path through a bridge transaction, while a non-corresponding outcome fails to activate it. | #56, #66, #67, #68, #69, #70, #71, #72, #73, #74, #75, #110 | Deterministic parent-CET-to-bridge-to-child smoke transcript, wrong-outcome negative check, transaction ids or regtest-equivalent artifacts. | [`docs/L2_SINGLE_CDLC_SCENARIO.md`](L2_SINGLE_CDLC_SCENARIO.md) defines the canonical single-parent/single-child scenario for #66; [`docs/L2_PARENT_FUNDING_HARNESS.md`](L2_PARENT_FUNDING_HARNESS.md) records the deterministic signed parent funding tx for #67; [`docs/L2_PARENT_CET_HARNESS.md`](L2_PARENT_CET_HARNESS.md) records the serialized parent CET, stable txid, sighash inputs, and edge output for #68; [`docs/L2_BRIDGE_HARNESS.md`](L2_BRIDGE_HARNESS.md) records the serialized bridge and child funding output for #69; [`docs/L2_BRIDGE_ADAPTOR_COMPLETION.md`](L2_BRIDGE_ADAPTOR_COMPLETION.md) records pre-resolution failure, `s_x` completion, and `s_y` rejection for #70; [`docs/L2_PARENT_CET_CONFIRMATION.md`](L2_PARENT_CET_CONFIRMATION.md) records deterministic parent CET confirmation for #71; [`docs/L2_BRIDGE_CONFIRMATION.md`](L2_BRIDGE_CONFIRMATION.md) records deterministic bridge confirmation and unspent child funding evidence for #72; [`docs/L2_CHILD_PREPARED_SPENDS.md`](L2_CHILD_PREPARED_SPENDS.md) records child CET/refund prepared-spend evidence for #73; [`docs/L2_EDGE_REFUND_TIMEOUT.md`](L2_EDGE_REFUND_TIMEOUT.md) records parent edge refund timelock evidence for #74; [`docs/L2_E2E_TRANSCRIPT.md`](L2_E2E_TRANSCRIPT.md) records the redacted replayable Layer 2 transcript artifact for #75. Full public testnet broadcast remains a later Layer 2 artifact unless completed separately. | Local deterministic execution is not the same as public mempool confirmation. Fee policy, pinning, and live broadcast remain outside the smoke test. |
