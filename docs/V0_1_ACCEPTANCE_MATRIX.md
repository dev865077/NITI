...
| Public evidence package | Let an external reviewer reproduce or audit the v0.1 claim without private context. | #108, #131, #132, #133, #134, #135, #136 | Redacted transcript, tx evidence bundle, auditor quickstart, limitations document, technical demo script, status badge/page. | #132 has a Bitcoin Core regtest transaction evidence bundle in [`docs/evidence/issue-132-regtest/`](evidence/issue-132-regtest/) with an offline verifier. #133 is covered by [`docs/AUDITOR_QUICKSTART.md`](AUDITOR_QUICKSTART.md) and [`docs/evidence/auditor-quickstart/demo-v0.1.log`](evidence/auditor-quickstart/demo-v0.1.log). #134 is covered by [`docs/V0_1_LIMITATIONS.md`](V0_1_LIMITATIONS.md). #135 is covered by [`docs/V0_1_TECHNICAL_DEMO.md`](V0_1_TECHNICAL_DEMO.md) and `npm run demo:v0.1`. Remaining issues cover broader public packaging. | Evidence can become stale unless tied to a commit and CI/artifact run. Regtest evidence is not public testnet/signet evidence. |
